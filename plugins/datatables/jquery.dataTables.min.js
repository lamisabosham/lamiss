...
(function (l) {
	...
	function Fb(a) {
		...
		for (b = g.length; k < b; k++) {
			...
			a.oFeatures.bSort &&
				...
				!1 !== m.bSortable && (n.attr("tabindex", a.iTabIndex).attr("aria-controls", a.sTableId), fb(a, m.nTh, k)));
	...
	function Kb(a) {
		var b = a.oClasses,
			...
			e = a.oPreviousSearch,
			h = a.aanFeatures,
			f = '<input type="search" placeholder="Search" class="' + b.sFilterInput + '"/>',
			g = d.sSearch;
	...
	B.register = y = function (a, b) {
		if (Array.isArray(a)) for (var c = 0, d = a.length; c < d; c++) B.register(a[c], b);
			...
			for (c = d.length; a < c; a++) {
				...
				a === c - 1
					? ((g.val = b),
					  (g.type = "function" === typeof b ? "function" : l.isPlainObject(b) ? "object" : "other"))
	...
	u.defaults = {
		...
		oLanguage: {
			...
			sUrl: "",
			sZeroRecords: "لا يوجد تطابق في البحث",
		},
